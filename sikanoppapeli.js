...
function jaa() {
    ...
    if (pelivuoro==3&&pelaajienMaara==3) {
        pelivuoro=1;
        document.getElementById("pelivuoro").innerText=pelivuoro;
    ...
    function vuoronvaihto() {
        ...
        document.getElementById("slot1").src=("0.png");
        document.getElementById("slot2").src=("0.png");
        document.getElementById("pisteetNyt").innerText=pisteetnyt;
        document.getElementById("tuplaMaara").innerText=tuplat;
    }
function vaihda() {
...
function validateKaksi() {
    var a = document.forms["kokohomma1"]["user1"].value;
    console.log(a);
    document.getElementById("nimi1").innerHTML = a;
    var b = document.forms["kokohomma1"]["user2"].value;
    console.log(b);
    document.getElementById("nimi2").innerHTML = b;
    return false;
}
function validateKolme() {
    var a = document.forms["kokohomma2"]["user1"].value;
    console.log(a);
    document.getElementById("nimi1").innerHTML = a;

    var b = document.forms["kokohomma2"]["user2"].value;
    console.log(b);
    document.getElementById("nimi2").innerHTML = b;

    var c = document.forms["kokohomma2"]["user3"].value;
    console.log(c);
    document.getElementById("nimi3").innerHTML = c;
    return false;
}
function ykkonen() {
    pisteetnyt = 0;
    var yksi = new Audio("ykkoset.mp3");
    yksi.play();
    jaa();
}
function tupla() {
    if (noppienMaara == 2) {
    var tuplaAani = new Audio("tuplat.mp3");
    tuplaAani.play();
    }
    
}
function valikkoAani() {
    var aani = new Audio("closedhihat.mp3");
    aani.play();
}
function aloitusAani() {
    var aloitusaani = new Audio("halfhihat.mp3");
    aloitusaani.play();
}
function heittoAani() {
    var heitoaani = new Audio("heitto.mp3");
    heitoaani.play();
}
